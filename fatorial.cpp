...
main(){
	...
	//unsigned long long é uma variavel que representa um número inteiro sem sinal (ou seja, somente positivo ou zero) e com 64 bits de tamanho, permitindo armazenar números muito grandes.
